...
var apiPages = {
    ...
    "/api-key": require("./apiKeyController"),
...
exports.handleQuery = (req, res, conn) => {
    ...
    if (!(baseApiSelector in apiPages)) handleError(req, res, 3, "Page '" + baseApiSelector + "' was not found as a valid endpoint");
    else apiPages[baseApiSelector].controller(req, res, conn);
}